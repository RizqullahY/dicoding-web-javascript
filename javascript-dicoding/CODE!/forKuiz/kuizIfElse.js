...
function scoreChecker(score) {
   let result;
   if (score < 60){           
      result = "Anda mendapatkan nilai E."   // Logika seperti ini alangkah lebih baik jika dimulai dari yang lebih kecil
   }
   else if (score < 70){
      ...
      result = "Selamat! Anda mendapatkan nilai A."   // Otomatis >= 90      
   }
